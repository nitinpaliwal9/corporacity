-- Row Level Security (RLS) Policies for Corporacity - FIXED VERSION
...
-- Users can view companies they own (no circular reference)
CREATE POLICY "Users can view owned companies" ON corp_companies
  FOR SELECT USING (owner_id = auth.uid());

-- Users can view companies they are members of (separate policy to avoid recursion)
...
-- Only authenticated users can create companies (simplified)
...
-- ==============================================
-- MEMBERSHIPS TABLE POLICIES (FIXED)
-- ==============================================
...
-- Company owners can view memberships for their companies (no circular reference)
...
-- ==============================================
-- JOIN_REQUESTS TABLE POLICIES (FIXED)
-- ==============================================
...
-- ==============================================
-- CORP_PROFILES TABLE POLICIES (FIXED)
-- ==============================================
